...
@section('title', 'Створити фільтр')

@section('content_header')
    <h1 class="m-0 text-dark">Створити фільтр</h1>
@stop
                                ...
                                <div class="tab-pane" id="option">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="brand"
                                            ...
                                            <option @if (in_array($brand->id, old('brand', []))) selected
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" max="999999" step="1"
                                            ...
                                            id="price_until" name="price_until" value="{{ old('price_until') }}"

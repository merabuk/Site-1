...
<h1 class="m-0 text-dark">Створити товар</h1>
@stop
                        ...
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="tab-pane active" id="main">
                                    ...
                                    {{-- Нейм --}}
                                    <div class="form-group">
                                        <label for="name" class="red-star">Назва товара</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name') }}" placeholder="Введіть назву">
                                        @error('name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text"
                                            ...
                                            name="details" rows="3"
                                            placeholder="Введіть опис">{{ old('details') }}</textarea>
                                        @error('details')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="brand_id"
                                            ...
                                            name="brand_id">
                                            <option @if (old('brand_id')=='' ) selected @endif value=''>Без бренда
                                            </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category_id"
                                            ...
                                            <option @if (in_array($category->id, old('category_id', []))) selected
                                                @endif
                                    ...
                                    <div class="form-group">
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="is_active"
                                                name="is_active" value="1" @if (old('is_active')) checked @endif>
                                ...
                                <div class="tab-pane" id="price">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="0.01"
                                            ...
                                            name="price" value="{{ old('price') }}" placeholder="Введіть ціну товара">
                                        @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="0.01"
                                            ...
                                            id="dealer_price" name="dealer_price" value="{{ old('dealer_price') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-switch-on-success">
                                            <input type="checkbox" class="custom-control-input" id="is_new"
                                                name="is_new" value="1" @if (old('is_new')) checked @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-switch-on-success">
                                            <input type="checkbox" class="custom-control-input" id="on_sale"
                                                name="on_sale" value="1" @if (old('on_sale')) checked @endif>
                                ...
                                <div class="tab-pane" id="option">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="material"
                                            ...
                                            @foreach (old('material', []) as $material)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="direction"
                                            ...
                                            @foreach (old('direction', []) as $direction)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            ...
                                            name="length" value="{{ old('length') }}" placeholder="Введіть довжину">
                                        @error('length')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            ...
                                            name="width" value="{{ old('width') }}" placeholder="Введіть ширину">
                                        @error('width')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            ...
                                            name="height" value="{{ old('height') }}" placeholder="Введіть висоту">
                                        @error('height')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="dim_unit"
                                            ...
                                            name="dim_unit">
                                            <option @if (old('dim_unit')=='' ) selected @endif value=''>Введіть одиниці
                                                виміру</option>
                                            @foreach ($dim_units as $dim_unit)
                                            <option @if (old('dim_unit')==$dim_unit['unit']) selected @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            ...
                                            name="weight" value="{{ old('weight') }}" placeholder="Введіть масу">
                                        @error('weight')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="weight_unit"
                                            ...
                                            name="weight_unit">
                                            <option @if (old('weight_unit')=='' ) selected @endif value=''>Введіть
                                                одиниці виміру</option>
                                            @foreach ($weight_units as $weight_unit)
                                            <option @if (old('weight_unit')==$weight_unit['unit']) selected @endif
                                ...
                                <div class="tab-pane" id="photo">
                                    <div class="form-group">
                                        ...
                                        <images-upload :errors="{{ $errors }}" path-to-save="images/products">
                                        </images-upload>
                                    </div>
                                    <div class="form-group">
                                        <label>Додаткові зображення товару</label>
                                        <images-upload path-to-save="images/products" :errors="{{ $errors }}"
                                            :multi-upload=@json(true)></images-upload>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
            ...
            $('#discount_from, #discount_until, #promotion_from, #promotion_until').datetimepicker(
                {
                    locale: 'uk',
                    icons: {
                    time: "fa fa-clock",

...
@section('content_header')
    <h1 class="m-0 text-dark">Редагувати бренд</h1>
@stop
                                ...
                                <div class="tab-pane active" id="main">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('keywords') is-invalid @enderror" id="keywords" name="keywords"
                                            value="{{ old('keywords', $brand->keywords) }}" placeholder="Введіть ключові слова">
                                        @error('keywords')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="3" placeholder="Введіть SEO опис">{{ old('description', $brand->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                                            value="{{ old('title', $brand->title) }}" placeholder="Введіть заголовок бренду">
                                        @error('title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control @error('details') is-invalid @enderror" id="details" name="details"
                                            rows="3" placeholder="Введіть опис">{{ old('details', $brand->details) }}</textarea>
                                        @error('details')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('brand_order') is-invalid @enderror" id="brand_order" name="brand_order"
                                            value="{{ old('brand_order', $brand->brand_order) }}" placeholder="Введіть порядковий номер бренду">
                                        @error('brand_order')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" @if (old('is_active', $brand->is_active)) checked @endif>
                                ...
                                <div class="tab-pane" id="photo">
                                    <div class="form-group">
                                        ...
                                        <images-upload :errors="{{ $errors }}"
                                            parent-model-class="{{ get_class($brand) }}"
                                            :parent-model-id="{{ $brand->id }}"
                                            :images="{{ $brand->mainImage }}"
                                ...
                                <div class="tab-pane" id="video">
                                    <div class="form-group">
                                        ...
                                        <videos-upload :errors="{{ $errors }}"
                                            :videos="{{ $brand->videos }}"></videos-upload>
                                    </div>
                                </div>

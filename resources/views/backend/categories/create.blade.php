...
<h1 class="m-0 text-dark">Створити категорію</h1>
@stop
                    ...
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="#main" data-toggle="tab">
                                @if($errors->first('name') || $errors->first('slug') || $errors->first('import_code') || $errors->first('category_id') || $errors->first('keywords') || $errors->first('description') || $errors->first('details'))
                        ...
                        <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="tab-pane active" id="main">
                                    <name-slug title="категорії" old-name="{{ old('name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min=1 class="form-control @error('import_code') is-invalid @enderror"
                                            id="import_code" name="import_code" value="{{ old('import_code') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category_id" class="form-control select2 @error('category_id') is-invalid @enderror"
                                            name="category_id">
                                            <option @if (old('category_id')=='' ) selected @endif value=''>Без категорії
                                            </option>
                                            @foreach ($parents as $parent)
                                            <option @if (old('category_id')==$parent->id) selected @endif

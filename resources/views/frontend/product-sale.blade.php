...
@section('content')
@include('frontend.includes.breadcrumb', ['crumb' => 'Розпродаж'])
<section class="bg-catalog">
    <div class="container">
        <div class="main page-catalog">
            <h3 class="title-section title-section-2 pb-md-0">Розпродаж</h3>
            ...
            @else
                <p class="text-center" style="height: 296px">Нажаль зараз немає жодного товару у розпродажі</p>
            @endif
        </div>
    </div>
</section>

...
@section('content')
@include('frontend.includes.breadcrumb', ['crumb' => 'Каталог'])
<div class="bg-catalog">
    <div class="container">
        <div class="main page-catalog">
            <h3 class="title-section title-section-2 pb-md-0">Каталог</h3>
            ...
            @else
                <p class="text-center">Нажаль зараз немає жодного товару у розпродажі</p>
            @endif
        </div>
    </div>
</div>

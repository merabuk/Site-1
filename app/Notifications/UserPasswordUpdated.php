...
class UserPasswordUpdated extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject(Lang::get('User Password Updated Notification'))
                    ->greeting(Lang::get('Good day!'))
                    ->line(Lang::get(':fullName, Your password has been changed successfully.', ['fullName' => $this->user->full_name, 'siteName' => config('app.name')]))
                    ...
                    ->line(Lang::get('Thank you that used our site.'))

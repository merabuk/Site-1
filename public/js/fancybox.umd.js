...
/***/ "./resources/js/plugins/fancybox.umd.js":
/*!**********************************************!*\
  !*** ./resources/js/plugins/fancybox.umd.js ***!
  \**********************************************/
...
!function (t, e) {
  ...
  function c(t, e) {
    return !e || "object" != _typeof(e) && "function" != typeof e ? l(t) : e;
  }
  ...
  var g = function g(t) {
    ...
    return o(t, [{
      ...
      value: function value(t, e) {
        ...
        var i,
            n,
            o = (i = t, n = this.options, i.split(".").reduce(function (t, e) {
          return t[e];
        }, n));
    ...
    return o(n, [{
      ...
      key: "removePointer",
      value: function value(t) {
        if (t.touches) for (; this.pointers.length;) {
          this.pointers.pop();
        } else {
  ...
  var T = {
    ...
    return o(n, [{
      ...
      value: function value() {
        ...
        if (Number.isInteger(r) && this.elemDimWidth > this.wrapDimWidth) for (var l = 0; l < this.slides.length; l += r) {
          a.push({
    ...
    return o(t, [{
      ...
      value: function value(t) {
        ...
        t.Panzoom || (t.Panzoom = new C(t.$el, m(!0, this.fancybox.option("Image.Panzoom"), {
          ...
          wheel: null,
          on: {
            afterAnimate: function afterAnimate(i) {
  ...
  var F = function F() {
    ...
    return o(n, [{
      ...
      value: function value() {
        ...
        if (this.Carousel.destroy(), this.detachPlugins(), this.Carousel = null, this.options = {}, this.events = {}, this.$container.remove(), this.$container = this.$backdrop = this.$carousel = null, t) if (H) t.focus({
          preventScroll: !0
        });else {
...
/******/ 	__webpack_require__("./resources/js/plugins/fancybox.umd.js");
/******/ })()
;